...
- Where and how should Zion Tech Hub grow organically outside Nigeria?
...
- International interest is real and repeatable. Nigeria, South Africa, Ghana, and Kenya are consistently the top four countries across both cohorts. Of the three non-Nigerian markets, Kenya is the only one that grew between cohorts (8.2% to 11.9% share), making it the clearest single market to prioritize next.
...
Full reasoning and evidence: [`reports/findings.md`](reports/findings.md)

## Recommendations

**Ad budget allocation:** 55% X (Twitter), 30% LinkedIn, 10% test budget on Facebook/Instagram reactivation, 5% referral incentives. No budget recommended for WhatsApp as an acquisition channel given its steep decline. Audience targeting is built in: X's broad, mixed audience (led by Students/Graduates, Tech/Data, and Business/Entrepreneurship, 45% of Cohort 10 combined) versus LinkedIn's Healthcare-leaning audience.
...
6. Prioritize Kenya specifically for international growth, reached via X (Twitter) and LinkedIn, not WhatsApp
7. Lean into the founder's personal LinkedIn brand as a zero-cost lever for LinkedIn and Healthcare Data Analytics growth

Full allocation reasoning and numbered detail, including recommendations for how future data collection can avoid the cleaning issues found in this project: [`reports/conclusion.md`](reports/conclusion.md)
